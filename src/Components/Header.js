         ...
         <header id="home">
            ...
            <nav id="nav-wrap">
               ...
               <ul id="nav" className="nav">
                  ...
                  <li><a className="smoothscroll" href="#show-skills">Projects</a></li>
                  <li><a className="smoothscroll" href="#contact-me">Contact</a></li>
               </ul>
            </nav>

            <div className="row banner">
               <div className="banner-text">
                  <h1 style={{ fontSize: "60px" }}>I'm {name}.</h1>
                  <h3> <span>{occupation}</span>
